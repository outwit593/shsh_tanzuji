<template>
  <div class="dashboard-container">
    ...
    <el-card class="cardMap">
      ...
      <div class="mapTXWSY" @click="Tanxianweishiyebu">
        <p style="text-align: center;">碳纤维事业部</p>
        <p style="text-align: center;">data</p>
      </div>
      <div class="mapHCSZ" @click="Hechengshuzhibu">
        <p style="text-align: center;">合成树脂部</p>
        <p style="text-align: center;">data</p>
      </div>
      <div class="mapHG" @click="Huagongbu">
        <p style="text-align: center;">化工部</p>
        <p style="text-align: center;">data</p>
      </div>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    Tanxianweishiyebu() {
      this.$router.push({ path: '/documentquery/tanxianweishiyebu' })
      
    },
    Hechengshuzhibu() {
      this.$router.push({ path: '/documentquery/hechengshuzhibu' })
    },
    Huagongbu() {
      this.$router.push({ path: '/documentquery/huagongbu' })
    },
    Huanbaoshuiwubu() {
      this.$router.push({ path: '/documentquery/huanbaoshuiwubu' })
    },
    Redianbu() {
      this.$router.push({ path: '/documentquery/redianbu' })
    }
  }
}
</script>
